...
#if our script does not have https
#verification and if it also does not
#have an ssl’s unverified context, then
#we are creating a default https
#unverified context for our python
#script using the SSL module
